...
<head>
    ...
    <link rel="stylesheet" href="sertext.css">
    ...
    <div id="maincontainer" >
        <nav id="navbar">
            ...
            <div id="navbarsec-2">
                ...
                <div id="searchsec">
                    <input type="text" name="searchtext" id="" placeholder="Search hear..">
                    <form action="" method="POST"><button id="bb" type="submit" name="serchbtn" >Search</button></form>
                </div>
            </div>
        </nav>
        ...
        <form id="productbody" action="" method="POST">
            ...
            $query = "select * from product where pname='$serchtext'";
...
<?php
    ...
    if(isset($_POST['serchbtn'])){
        $sertext=$_POST['serchtext'];
        // $query="select * from product where pname='$sertext'";

        // header("LOCATION: index.php?msg=$sertext");
